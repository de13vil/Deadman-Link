...
const isLocalIp = (ip = '') => {
  ...
  return ip.startsWith('::ffff:127.') || ip.startsWith('127.');
};
...
const ipBlocker = (req, res, next) => {
  ...
  // Never auto-block local development traffic. Vite, Socket.IO polling,
  // browser reloads, and API retries can legitimately exceed production limits.
